...
import { numericResponseExtension } from '../statementConstants/extensions';
...
export interface Action extends UserSiteAction {
  ...
  /** The number provided to answer the question. */
...
/**
 * Creates an xAPI Statement to represent a user's answering a survey question with a number.
 */
export default function answeredNumericSurveyQuestion(action: Action): Statement {
  return {
    ...
    result: {
      ...
      extensions: {
        [numericResponseExtension]: action.answer,
