...
import { selectionResponseExtension } from '../statementConstants/extensions';
...
export interface Action extends UserSiteAction {
  ...
  /** The selections provided to answer the question. */
  readonly answerSelections: string[];
...
export default function answeredSelectionSurveyQuestion(action: Action): Statement {
  return {
    ...
    result: {
      extensions: {
        [selectionResponseExtension]: action.answerSelections,
